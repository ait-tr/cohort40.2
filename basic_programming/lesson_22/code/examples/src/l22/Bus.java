...
public class Bus extends Vehicle {
    ...
    private int countPassengers = 0; // по умолчанию установлено в 0
    ...
    public void setCapacity(int capacity) {
        ...
        if (this.capacity > 0) {
            System.out.println("Автобус не пуст, нельзя переоборудовать места " + this.getModel());
        }
        else {
            this.capacity = capacity;
            System.out.println("Переоборудовали места автобуса " + this.getModel());
        }
    }
